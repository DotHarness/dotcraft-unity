  ...
  ""additionalProperties"": false
            ...
            Stopwatch stopwatch)
        {
            ...
            var result = await RunExecuteCSharpAsync(
                ...
                args["args"] as JObject, ct).ConfigureAwait(false);
            ...
            CancellationToken ct)
        {
            ...
            return MainThreadDispatcher.RunOnMainThread(
                token => RuntimeToolOutcome.InvokeAsync(tool, arguments, token),
                timeoutMs: 60000, cancellationToken: ct);
        }
            ...
            CancellationToken ct)
        {
            ...
            if (MainThreadDispatcher.IsMainThread)
                return ExecutionRouter.Instance.ExecuteAsync(request, ct);

            return MainThreadDispatcher.RunOnMainThread(
                token => ExecutionRouter.Instance.ExecuteAsync(request, token),
                timeoutMs: 60000, cancellationToken: ct);
        }
