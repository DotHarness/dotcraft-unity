...
namespace DotCraft.Editor.Protocol
{
    ...
    {
        /// <summary>Versioned DotCraft Runtime Tools extension capability.</summary>
    ...
    internal sealed class AcpRuntimeToolCallResult
    {
        [JsonProperty("success")]
        public bool Success { get; set; }

        [JsonProperty("contentItems", NullValueHandling = NullValueHandling.Ignore)]
        public List<AcpRuntimeToolContentItem> ContentItems { get; set; }
    ...
    internal sealed class AcpRuntimeToolContentItem
    {
        [JsonProperty("type")]
