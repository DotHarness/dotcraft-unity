...
internal sealed class CliFixture : IDisposable
{
    ...
    public void WriteDiscovery(int? protocolVersion = null, string? productVersion = null,
        string? endpoint = null, int? pid = null) =>
        WriteJson(GatewayConstants.DiscoveryRelativePath, new
        {
            protocolVersion = protocolVersion ?? GatewayConstants.ProtocolVersion,
            packageVersion = productVersion ?? GatewayConstants.ProductVersion,
